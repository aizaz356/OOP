// array, 2d array, string, struct examples
...
void array_test()
{
    int a[5];   // fixed size, contiguous memory locations!
                // a poor man's list
...
void string_test()
{
    ...
    cout << "Is name empty?" << name.empty() << endl;  // exactly the same. So, we'll use this.
    cout << "Is length empty?" << name.length() << endl; 
}
