// delete(free) operator -> memory free
...
int main () {
    ...
    s = &s1;         // s stores the address of s1// one way of getting the address ... 
...
*/
    ...
    delete s; //Rules: We give pointer to delete       ,       Only delete those things that is created with new
